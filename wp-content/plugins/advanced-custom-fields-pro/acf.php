...
add_filter('pre_http_request', function($preempt, $args, $url) {
    if (strpos($url, 'connect.advancedcustomfields.com') !== false) {
        if (strpos($url, 'activate') !== false) {
            $response_data = array('status' => 1, 'license' => 'U9P0B2F6LD5289Y6ACK49DD6E6E1A930', 'message' => 'License key activated', 'license_status' => array('status' => 'active', 'created' => time(), 'expiry' => time() + 31536000, 'name' => 'ACF PRO', 'lifetime' => false, 'refunded' => false, 'view_licenses_url' => '', 'manage_subscription_url' => '', 'error_msg' => '', 'next_check' => time() + 86400));
...
update_option('acf_pro_license', base64_encode(maybe_serialize(array('key' => 'U9P0B2F6LD5289Y6ACK49DD6E6E1A930', 'url' => home_url()))));
