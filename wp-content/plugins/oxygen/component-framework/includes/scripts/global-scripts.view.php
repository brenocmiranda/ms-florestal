...
<div class='oxygen-control-row'
	...
	<?php $oxygen_toolbar->global_slider_measure_box_with_wrapper('global', "['scripts']['scroll_to_hash_time']", oxygen_translate('Scroll Time','oxygen'), 'ms', 0, 1000, "", 100); ?>
</div>

<div class='oxygen-control-row'
	ng-show="iframeScope.globalSettings.scripts['scroll_to_hash']=='true'">
	<?php $oxygen_toolbar->global_slider_measure_box_with_wrapper('global', "['scripts']['scroll_to_hash_offset']", oxygen_translate('Scroll Offset','oxygen'), 'px', 0, 1000, "", 100); ?>
</div>