...
Class Oxy_Tabs_Content extends CT_Component {
	...
	function add_shortcode( $atts, $content, $name ) {
		...
		?><script type="text/javascript">var firstTab = document.querySelector('#<?php echo esc_attr($options['selector']); ?> > .oxy-tabs-contents-content-hidden:first-child'); if(firstTab && firstTab.classList){firstTab.classList.remove("oxy-tabs-contents-content-hidden")};</script><?php
